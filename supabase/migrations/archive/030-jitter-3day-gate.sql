-- 030-jitter-3day-gate.sql
-- 3-day account age gate: votes from accounts < 3 days old are stored
-- but excluded from ranking calculations. They retroactively count
-- once the account matures (live queries re-evaluate on each call).
-- AI-estimated votes always count regardless of account age.
--
-- Run in Supabase SQL Editor to deploy.

-- =============================================
-- 1. UPDATE MATERIALIZED STATS TRIGGER
-- =============================================
...
-- =============================================
-- 2. UPDATE get_ranked_dishes (browse/home)
-- =============================================
...
BEGIN
  ...
  -- Account age gate: votes from accounts < 3 days old excluded
  mature_user_ids AS (
...
-- =============================================
-- 3. UPDATE get_restaurant_dishes
-- =============================================
