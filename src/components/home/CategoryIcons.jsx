...
const posterIcons = {
  pizza: '/categories/poster/pizza-pix.png',
  burger: '/categories/poster/burger-pix.png',
  seafood: '/categories/poster/seafood-pix.png',
  wings: '/categories/poster/wings-pix.png',
  sushi: '/categories/poster/sushi-pix.png',
  breakfast: '/categories/poster/breakfast-pix.png',
...
const dishNameIcons = [
  ...
  { match: 'pizza', src: '/categories/poster/pizza-pix.png' },
  ...
  { match: 'benedict', src: '/categories/poster/eggs-benedict-pix.png' },
  { match: 'cauliflower', src: '/categories/poster/veggies-pix.png' },
  { match: 'carrot', src: '/categories/poster/veggies-pix.png' },
  ...
  { match: 'fries', src: '/categories/poster/fries-pix.png', solo: true },
  { match: 'french fry', src: '/categories/poster/fries-pix.png', solo: true },
  ...
  { match: 'rib', src: '/categories/poster/ribs-pix.png' },
  ...
  { match: 'bruschetta', src: '/categories/poster/bruschetta-pix.png' },
