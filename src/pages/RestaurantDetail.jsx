        ...
        <div className="space-y-3">
          {restaurant.address && (
            <a
              ...
              className="flex items-start gap-3 transition-opacity hover:opacity-80 group"
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 mt-0.5 flex-shrink-0 group-hover:opacity-80" style={{ color: 'var(--color-divider)' }}>
